# Обобщенные модели боевых действий Ланчестера
...
В этом блокноте мы рассматрим обобщенные [модели боевых действий Ланчестера](https://en.wikipedia.org/wiki/Lanchester%27s_laws) и
...
**Примечание:** Содержание этого блокнота намеренно теоретически
фундаментально, но кратко и просто как с математической точки зрения, так и с точки
зрения представленного кода. Цель автора состоит в том, чтобы разработать
